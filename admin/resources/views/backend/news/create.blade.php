...
@section('content')
    {{ Form::open(['route' => 'admin.createpost', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}
                    ...
                    <div class="avatar-upload" style="height: 300px;width: 300px">
                        <div id="containers">
                            <a href="javascript:void(0)" id="pickfiles" onclick="inter()">
                                <img id='inner' src="/img/pszhaopian.png" alt=""></a>
                        </div>
...
@section('after-scripts')
    ...
    <script type="text/javascript" src="{{URL::asset('/js/liandong.js')}}"></script>
    <script>
$(function(){
    $.ajax({
        type : 'get',
