...
@section ('title', trans('labels.backend.access.users.comment'))
        ...
        <div class="table-responsive">
            <table id="table" class="table table-condensed table-hover" data-toggle="table"
                ...
                <tr>
                    ...
                    <th data-field="navigation" >文章标题</th>
                    <th data-field="title" >评论人数</th>
                    <th data-field="statuss">回复人数</th>
                    <th data-field="content">点赞次数</th>
...
<script>
    ...
    function actionFormatter(value, row, index) {
        var pinglun = '<a href="{{ url('admin/edit') }}'+'/'+row.id+'" class="btn btn-xs btn-warning">' +
        '<i class="fa fa-pencil auth" data-toggle="tooltip" data-placement="top" title="评论详情">评论详情</i></a>';

        var huifu = '<a href="{{ url('admin/edit') }}'+'/'+row.id+'" class="btn btn-xs btn-success">' +
            '<i class="fa fa-pencil auth" data-toggle="tooltip" data-placement="top" title="回复详情">回复详情</i></a>';

        var del = '<a href="javascript:void()" class="btn btn-xs btn-danger"> ' +
            '<i class="fa fa-times remove" data-toggle="tooltip" data-placement="top" ' +
            'data-toggle="tooltip" data-placement="top" title="删除">删除</i></a>';

        if(row.status == '1'){
            var freeze = ''
            return pinglun+' '+freeze+' '+huifu+' '+del;
